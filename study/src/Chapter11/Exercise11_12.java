...
class SutdaDeck {
	...
	void registerJokbo() {
		...
		jokbo.put("KK", 4000);		jokbo.put("12", 2060);
		jokbo.put("1010", 3100);	jokbo.put("21", 2060);
		jokbo.put("99", 3090);		jokbo.put("14", 2050);
		jokbo.put("88", 3080);		jokbo.put("41", 2050);
		jokbo.put("77", 3070);		jokbo.put("19", 2040);
		jokbo.put("66", 3060);		jokbo.put("91", 2040);
		jokbo.put("55", 3050);		jokbo.put("110", 2030);
		jokbo.put("44", 3040);		jokbo.put("101", 2030);
		jokbo.put("33", 3030);		jokbo.put("410", 2020);
		jokbo.put("22", 3020);		jokbo.put("104", 2020);
		jokbo.put("11", 3010);		jokbo.put("46", 2010);
									jokbo.put("64", 2010);
		
	}
	
	int getPoint(Player p) { // 게임참가자의 점수를 계산해서 반환
		if(p == null) return 0;
		...
		/* 아래의 로직에 맞게 코드를 작성하시오.
	    	1. 카드 두 장이 모두 광이면, jokbo 에서 키를 "KK"로 해서 점수를 조회한다.
			2. 두 카드의 숫자(num)로 jokbo 에서 등급을 조회한다.
...
//		} else {
//			if(jokbo.containsKey(c1.num) && jokbo.containsKey(c2.num)) {
