package Chapter11;
import java.util.*;
/* [11-13] 다음 코드는 문제 11-12를 발전시킨 것으로 각 Player들의 점수를 계산하고, 점수가 제일 높은 사람을 출력하는 코드이다.
...
public class Exercise11_13 {
	public static void main(String args[]) throws Exception {
		...
		TreeMap rank = new TreeMap(new Comparator(){ // 점수가 제일 높은 사람부터 내림차순 정렬
		...
		System.out.println();
		System.out.println("1위는 " + rank.firstKey() + " 입니다.");  // firstKey() - TreeMap에 저장된 첫번째 (가장 작은) 키를 반환.
	}
}	
